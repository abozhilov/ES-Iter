...
describe('isIterable', function () {
    ...
    it('Returns false if object is not iterable', function () {
        ...
        expect((0, _srcItertools.isIterable)(null)).toBe(false);
        expect((0, _srcItertools.isIterable)(undefined)).toBe(false);

        function f() {var x = arguments.length <= 0 || arguments[0] === undefined ? 10 : arguments[0];
            console.log(x);}
